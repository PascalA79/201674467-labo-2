...
exports.valueMatch=(value, searchValue)=>{
    try {
...
exports.innerCompare=(x, y)=>{
    if ((typeof x) === 'string' && (typeof y) === 'string')
         return x.localeCompare(y,'fr');
    else
        return exports.compareNum(x, y);
}

exports.sortByKey=(array, key)=>{
    return array.sort(function(a, b) {
        let x = a[key]; let y = b[key];
        return exports.innerCompare(x,y);
    });
}
...
exports.sortByKeyDesc=(array, key)=>{
    return array.sort(function(a, b) {
        let x = a[key]; let y = b[key];
        return exports.innerCompare(y,x);
    });
}
exports.filterByKey=(array,key,searchValue)=>{
    let resultats=array.filter(x=>{
        return exports.valueMatch(x[key],searchValue);
    });
    return resultats;
}
